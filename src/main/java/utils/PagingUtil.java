			...
			*/
			...
			if(intTemp != 1) {
				...
				pagingStr += ""
					...
					+ "<img src='./images/admin/paging_start.png'></a>";
				pagingStr += "&nbsp;";
				pagingStr += ""
					+ "<a href='"+page+"pageNum="+
									(intTemp-blockPage)+"'>"
					+ "<img src='./images/admin/paging_prev.png'></a>";
			}
			...
			*/
			...
			if(intTemp <= totalPage) {
				pagingStr += "<a href='"+page+"pageNum="+
												intTemp+"'>"
					+ "<img src='./images/admin/paging_next.png'></a>";
				pagingStr += "&nbsp;";
				pagingStr += "<a href='"+page+"pageNum="+
												totalPage+"'>"
					+ "<img src='./images/admin/paging_end.png'></a>";
			}
