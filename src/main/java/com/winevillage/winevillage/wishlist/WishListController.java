...
public class WishListController {
	...
	@PostMapping("/deleteWishItem.do")
	@ResponseBody
	public ResponseEntity<?> deleteWishItem(@RequestParam("productCode") String productCode, 
            @RequestParam("memberNo") String memberNo) {
	try {
			wishListService.deleteWishItem(productCode, memberNo);
