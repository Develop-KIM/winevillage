                ...
                <div class="layer_tit">SMART SEARCH</div>
	                ...
	                <!-- 검색창 시작 -->
	                    <div class="search_layer">
	                        <div class="search_box" style="position:relative;">
	                            <input type="text" name="searchKeyword" id="searchKeyword" placeholder='오늘 마시고 싶은 와인을 검색해 보세요' autocomplete="off" class="srch_close_event" value="" style="text-align: center; letter-spacing:0.3px;">
	                            <button type="submit" name="action_btn" value="search" id="s_btn" style="position:absolute;right:60px;opacity:0.3;">검색</button>
	                        </div>
	                ...
	                <!-- 검색창 끝 -->
		                        ...
		                        <div class="check_area ">
		                            ...
		                            <div class="check_type">
		                                <div class="checkbox type2">
		                                    <input type="checkbox" name="searchField_wine" id="type_check_29" value="레드" data-nm="레드" onclick="filter_submit();">
		                                    <label for="type_check_29">레드 <!--()--></label>
		                                </div>
		                                <div class="checkbox type2">
		                                    <input type="checkbox" name="searchField_wine" id="type_check_28" value="화이트" data-nm="화이트" onclick="filter_submit();">
		                                    <label for="type_check_28">화이트<!--()--></label>
		                                </div>
		                                <div class="checkbox type2">
		                                    <input type="checkbox" name="searchField_wine" id="type_check_27" value="스파클링" data-nm="스파클링" onclick="filter_submit();">
		                                    <label for="type_check_27">스파클링<!--()--></label>
		                                </div>
		                                <div class="checkbox type2">
		                                    <input type="checkbox" name="searchField_wine" id="type_check_26" value="디저트" data-nm="디저트" onclick="filter_submit();">
		                                    <label for="type_check_26">디저트 <!--()--></label>
		                                </div>
		                                <div class="checkbox type2">
		                                    <input type="checkbox" name="searchField_wine" id="type_check_25" value="로제" data-nm="로제" onclick="filter_submit();">
		                                    <label for="type_check_25">로제 <!--()--></label>
		                                </div>
		                                <div class="checkbox type2">
		                                    <input type="checkbox" name="searchField_wine" id="type_check_100" value="주정강화" data-nm="주정강화" onclick="filter_submit();">
		                ...
		                <div class="bottom">
							...
							<div class="btn_area">
								<button type="submit" name="action_btn" value="apply" class="btn_txt btn_filter">적용</button>
							</div>
					</div>
	                </form>
                </div>
