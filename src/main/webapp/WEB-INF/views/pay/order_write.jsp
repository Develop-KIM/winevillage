...
<meta name="twitter:image"
	content="https://www.winenara.com/asset/images/kr/default/logo.png">
...
<link rel="stylesheet" type="text/css"
	href="css/layout.css?v=240409200930" />
<link rel="stylesheet" type="text/css"
	href="css/layout_pc.css?v=240409200935"
	media="screen and (min-width:1025px)">
<link rel="stylesheet" type="text/css"
	href="css/layout_jj.css?v=240409200935" />
<link rel="stylesheet" type="text/css"
	href="css/layout_pc_jj.css?v=240409200935"
	media="screen and (min-width:1025px)">
<link rel="stylesheet" type="text/css"
	href="css/layout_elly.css?v=240409200935" />
<link rel="stylesheet" type="text/css"
	href="css/layout_pc_elly.css?v=240409200935"
	media="screen and (min-width:1025px)">
<link rel="stylesheet" type="text/css"
	href="css/layout_ch.css?v=240409200935" />
<link rel="stylesheet" type="text/css"
	href="css/layout_pc_ch.css?v=240409200935"
	media="screen and (min-width:1025px)">
<link rel="stylesheet" type="text/css"
	href="css/layout_sy.css?v=240409200935" />
<link rel="stylesheet" type="text/css"
	href="css/layout_pc_sy.css?v=240409200935"
	media="screen and (min-width:1025px)">
<script type="text/javascript" src="js/jquery.min.js"></script>
<script type="text/javascript" src="js/jquery-ui.min.js"></script>
<script type="text/javascript" src="js/picturefill.min.js"></script>
<script type="text/javascript" src="js/front_ui.js?v=221226120920"></script>
<script type="text/javascript" src="js/common.js?v=221216102931"></script>
<script type="text/JavaScript"
...
<body>
	...
	<header id="header" class="header mypage_index_header">
			...
			<div class="wrap">
				<ul class="left_menu">
					<li class="language mb_hidden"><button type="button">
							<span><img class="langg"
								src="images/default/pc_icon_flag_korea_sq.png" alt=""></span><span
								class="txt">KOR</span>
						</button></li>
					<li class="language mb_hidden"><button type="button"
							onclick="location.href='/en/main'">
							<span class="langg"><img class="langg"
								src="images/default/pc_icon_flag_usa_sq.png" alt=""></span><span
								class="txt">ENG</span>
						</button></li>
					<li class="sns_area mb_hidden">
						...
						<ul>
							...
							<li><button type="button"
									onclick="window.open('https://www.instagram.com/winenara_official/')">
									<span class="ico_insta">인스타그램</span>
								</button></li>
							<!-- <li><button type="button" onclick="window.open('https://blog.naver.com/winenara2175')"><span class="ico_blog">네이버블로그</span></button></li> -->
							<li><button type="button"
									onclick="window.open('https://www.youtube.com/channel/UCCfl_ClO1lV5CNOmH8vRa2w')">
									<span class="ico_youtube">유튜브</span>
								</button></li>
							<li><button type="button"
									onclick="window.open('http://pf.kakao.com/_vlkxfxb')">
									<span class="ico_kakao">카카오톡채널</span>
								</button></li>
						</ul>
					</li>
					...
					<li class="mb_search_btn mb_hidden"><button type="button"
							onclick="commonUI.header.Search.clickFn()">Mobile Search</button></li>
				</ul>
				<h1 class="logo">
					<a href="/shop/main"> <picture> <!--[if IE 9]><video style="display: none;"><![endif]-->
				...
				<ul class="right_menu">
					<li class="cart"><a href="/shop/cart/cart_lists"> <span>Cart
								List</span> <span class="list-count">1</span>
					</a></li>
					...
					<li class="mb_hidden wish"><a
						href="/shop/mypage/note/wish_lists"><img
						...
						<div class="mypage_layer">
							<div class="on_login">
								<ul>
									...
									<li>
										<h3>가용 마일리지</h3>
										<p class="info">0P</p> <!-- <p class="sub_info">소멸예정 : 0P (2024.5<em>.01</em>)</p> -->
										<p class="sub_info">
											소멸예정 : 0P (<em> 2024.04.30 </em>)
										</p>
									</li>
									<li class="top_line">
										<h3>
											<a href="javascript:openProfile();">테이스트 프로파일</a>
										</h3>
									</li>
									<li class="top_line">
										<h3>
											<a href="/shop/mypage/shopping/mypage">마이페이지</a>
										</h3>
									</li>
									<li class="top_line">
										<h3>
											<a href="/shop/mypage/note/giftcard_lists">기프트카드</a>
										</h3>
									</li>
								</ul>
					...
					<li class="mb_hidden"><a href="/shop/cs/notice_lists"><img
							src="images/default/pc_icon_center.png" alt="Info Center"></a></li>
				</ul>
				<!-- 로그인했을 경우 나타나는 GNB 메뉴 -->
				<div class="summary_menu">
					<p>
						<a href="/shop/mypage/shopping/mypage">고객님</a>
					</p>
					<p>
						<a href="/shop/mypage/note/mileage_lists">마일리지<em>0P</em></a>
					</p>
					<p>
						<a href="/shop/mypage/note/coupon_lists">쿠폰<em>1</em></a>
					</p>
				</div>
			</div>
		</div>
		<div class="bottom">
			...
			<div class="wrap">
				...
				<div class="gnb">
					...
					<li><a href="/shop/product/product_lists?sh_category1_cd=40000">OTHER</a></li> -->
						<li class=""><a
							href="/shop/product/product_lists?sh_category1_cd=10000&amp;sh_category2_cd=10100">WINE</a>
						...
						<li class=""><a
							href="/shop/product/product_lists?sh_category1_cd=20000">BEER&amp;LIQUOR</a>
							<div class="pc_category_gnb">
								<div class="flex_box">
									<div class="box other">
										<ul>
						...
						<li class=""><a
							href="/shop/product/product_lists?sh_category1_cd=40000">OTHER</a>
							<div class="pc_category_gnb">
								<div class="flex_box">
									<div class="box other">
										<ul>
											...
											<li class="ico_ticket"><a
												href="/shop/product/product_lists?sh_category1_cd=50000">티켓</a>
											</li>
										</ul>
									</div>
								</div>
							</div></li>
						<li class=" pc_hidden "><a
							href="/shop/product/product_lists?sh_category1_cd=50000">티켓</a></li>
						<li style="display: none !important" class="mb_hidden opacity">
							<a href="/shop/product/best_product_lists?group_cd=20240206">En
								Primeur</a>
						</li>
						<li class="mb_hidden opacity"><a
							href="/shop/event/event_lists">PROMOTION</a></li>
						<li class="mb_hidden opacity"><a href="/shop/company/store">SHOP</a>
						</li>
						<li class=" opacity"><a href="/shop/company/mood"
							class="club-link">CLUB</a>
							<div class="pc_category_gnb">
								<div class="flex_box">
									<div class="box other" style="display: flex">
										<ul>
											<li><a href="/shop/company/mood" class="mood-live-link">MOOD
													LIVE</a></li>
											<li><a href="/shop/company/fnb_view?no=58">MOOD
													SEOUL</a></li>
											<li><a href="/shop/company/fnb_view?no=57">SAV SEOUL</a></li>
											<li><a href="/shop/company/fnb_view?no=102">TERRENO
													SEOUL</a></li>
											<li><a href="/shop/company/fnb_view?no=101">CLUB
													CORAVIN</a></li>
											<li><a href="/shop/company/fnb_view?no=97">MOWa</a></li>
											<li><a href="/shop/company/fnb_view?no=72">Le Monde
													Du Vin</a></li>
											<li><a href="/shop/company/fnb_view?no=63">E.O.D
													Pub&amp;Lounge</a></li>
						...
						<li class="mb_hidden opacity"><a
							href="/shop/community/brandstory_lists">BLOG&amp;VIDEO</a></li>
						<!-- <li class=" opacity">
						<a href="/shop/community/video_lists">VIDEO</a>
					</li> -->
						<li class="mb_hidden opacity"><a
							href="/shop/company/about_us">ABOUT US</a></li>
					</ul>
				...
				<div class="pc_category_gnb">
					<div class="flex_box">
						...
						<div class="box">
							<p class="tit">
								<a href="/shop/product/best_product_lists?group_cd=20240206"><strong>En
										Primeur</strong></a>
							</p>
							<p class="tit">
							...
							<ul>
								<li><a href="/shop/community/brandstory_lists">OUR
										BRANDS</a></li>
								<li><a href="/shop/community/magazine_con_lists">OUR
										STORIES</a></li>
							</ul>
						</div>
						<div class="box">
			...
			<a href="/shop/mypage/shopping/mypage" class="fixed_mypage"><img
				src="../../asset/images/shop/default/pc_icon_mypage.png"
		...
		<div class="mb_lnb pc_hidden">
			<ul>
				...
				<li class="btn_order"><button type="button"
						onclick="location.href='/shop/mypage/shopping/order_lists'">
						<span>ORDER LIST</span>
					</button></li>
				<li class="btn_search"><button type="button"
						onclick="commonUI.layer.open('category_layer')">
						<span>SEARCH</span>
					</button></li>
				...
				<li class="btn_wish"><button type="button"
						onclick="location.href='/shop/mypage/note/wish_lists'">
						<span>WISH LIST</span>
					</button></li>
				<li class="btn_mypage"><button type="button"
						onclick="location.href='/shop/mypage/shopping/mypage'">
						<span>MY PAGE</span>
					</button></li>
			</ul>
		</div>
		<form action="https://www.winenara.com/shop/order/barcode_view"
			...
			<input type="hidden" name="witplus_csrf_token"
				value="826caf4a31037286f831f231532bd8ac"> <input
					...
					<div class="layer_con">
						<ul>
							<li><strong class="tit">4월 이달의 와인</strong>
								...
								<div class="img">
									<img src="../../asset/images/shop/product/mb_recom_lnb.jpg"
										alt="">
								</div>
								<div class="btn_box">
					...
					<div class="layer_con">
						...
						<div class="category_area">
							<div class="box cate">
								...
								<ul>
									<li><a
										href="/shop/product/group_product_lists?group_cd=1901">신상품</a></li>
									<li><a
										href="/shop/product/group_product_lists?group_cd=1902">베스트</a></li>
    ...
    * 바코드 스크립트
	...
	<section id="contents" class="mb_margin_0" style="margin-top: 188px;">
		...
		<div class="wrap">
			<script type="text/javascript"
				src="../../asset/js/wn.order.js?v=240318123259"></script>
			<style>
.quick_menu {
	display: none
}
				...
				<div class="content order order_write_page">
						...
						<ul>
							<li>
								...
								<div class="box con">
									<div class="more_info">
										<p class="prd_name">
											<a href="/shop/product/product_view?product_cd=03T999">디아블로
												데블스 카나발 스위트</a>
										</p>
										<!--                                 <div class="icon type">
																			...
																			<span>
																					<img src="../../asset/images/shop/product/iocn/g505.png" alt="">
																			</span>
																			칠레                                </div>
															 -->
					...
					<div class="btn_area col2">
						<button type="button" class="btn_txt"
							onclick="location.href='/shop/cart/cart_lists'">
							<span>취소</span>
						</button>
						<button type="button" class="btn_txt btn_black"
	...
	$("#openCouponList").on("click", function() {
		...
		<!-- //page_script -->
		<script type="text/javascript"
			src="../../asset/js/kcp/approval_key.js"></script>
		<script>
	...
	<footer id="footer" class="footer">
		<div class="hidden_info">
			...
			<div class="info_box">
				...
				<div class="logo">
					<img src="images/defdefault/logo_footer.png" alt="WINENARA 1987">
				</div>
			</div>
		</div>
		<div class=" mb_hidden quick_menu">
			<ul class="list">
				...
				<li><a href="/shop/cs/special">
						<div class="icon">
							<picture> <!--[if IE 9]><video style="display: none;"><![endif]-->
							<source
								srcset="../../asset/images/shop/default/pc_ico_quick_delivery.png"
								media="(min-width:768px)">
							<!-- pc이미지 -->
							<source
								srcset="../../asset/images/shop/default/mb_ico_quick_delivery.png"
								media="(max-width:767px)">
							<!-- mb이미지 --> <!--[if IE 9]></video><![endif]--> <img
								src="../../asset/images/shop/default/pc_ico_quick_delivery.png"
				...
				<li><a href="http://pf.kakao.com/_vlkxfxb/chat"
					class="pc_hidden">
						<div class="icon">
							<picture> <!--[if IE 9]><video style="display: none;"><![endif]-->
							<source
								srcset="../../asset/images/shop/default/pc_ico_quick_talk.png"
								media="(min-width:768px)">
							<!-- pc이미지 -->
							<source
								srcset="../../asset/images/shop/default/mb_ico_quick_talk.png"
								media="(max-width:767px)">
							<!-- mb이미지 --> <!--[if IE 9]></video><![endif]--> <img
								src="../../asset/images/shop/default/pc_ico_quick_talk.png"
