			...
			<div class="product_lists_wrap">
				...
				<div class="prd_search">
					<div class="search_info">
						<h2>'셀러스'</h2>
						<p>
							검색어로 총 <span class="total_count_text">3</span>개의 상품검색
						</p>
					</div>
					<form action="/shop/product/search_product_lists" id="searchForm" method="get">
				...
				<div class="prd_list_area">
					<div class="search_result">
						...
						<p class="result">
							총<span class="total_count_text">3</span>개의 상품
						</p>
					</div>
