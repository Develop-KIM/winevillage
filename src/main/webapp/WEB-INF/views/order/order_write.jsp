    ...
    <section id="contents" class="mb_margin_0" style="margin-top: 188px;">
        <div class="lnb order_lnb lnb_wrap step_wrap">
            ...
            <div class="pc_lnb order_tit">
                <div class="page_tit">
                    <picture>
                        <source srcset="images/order/pc_smart_pickup.jpg" media="(min-width:768px)">
                        <source srcset="images/order/mb_smart_pickup.jpg" media="(max-width:767px)">
                        <img src="images/order/pc_smart_pickup.jpg" alt="스마트 픽업" draggable="false"> </picture>
                </div>
            </div>
        </div>
        <div class="wrap">
            ...
            <form action="order_write.do" id="orderForm" name="orderForm" method="post" accept-charset="utf-8">
                <input type="hidden" name="witplus_csrf_token" value="49e9b547a35b367f65c20229c78cc14e"> <input type="hidden" name="session_id" id="session_id" value="71u2njvsv4ist0gg22ue51rvobkjeol4">
                <div class="content order order_write_page">
                            ...
                            <li>
                                <div class="box ip_img">
                                    <picture style="background:#E0D8EA">
                                        <img src="../uploads/product/200/${row.productImg }" alt="">
                                    </picture>
                                </div>
                                ...
                                <div class="box con">
                                    <div class="more_info">
                                        <p class="prd_name">
                                            <a href="/product/product_view?product_cd=03T999">${row.productName }</a>
                                        </p>
                                        <span class="label" style="background:#E0D8EA">${row.wine }</span>
                                        <span class="label" style="background:#E0D8EA">${row.country }</span>
                                    </div>
                                </div>
                                <div class="box opt mb_hidden"></div>
                                <div class="box price_amount">
                                    <div class="box price" style="float:none;margin:0;text-align:right;">
                                        <ins><fmt:formatNumber value="${row.discountPrice}" pattern="#,###" />원</ins>
                                        <span>${row.orderAmount }EA</span>
                                    </div>
                                </div>
                            </li>
                                </c:forEach>
			      ...
			      <c:forEach items="${lists}" var="row" varStatus="loop">
			                ...
			                <ul>
			                	<li>
			                        <div>
			                            <input type="hidden" name="memberNo" id="memberNo" value="${ row.memberNo }">
			                        </div>
			                    <li>
			                        <div class='l_tit'>
			                        ...
			                        <div class='form_box'>
			                            <input type='text' id='or_name' name='name' value='${row.name}' readonly>
			                        </div>
			                    </li>
			                    <li>
			                        <div class='l_tit'>
			                        ...
			                        <div class='form_box'>
			                            <input type="text" id="or_email" name="email" value="${row.email}">
			                        </div>
			                    </li>
			                    <li>
			                        <div class='l_tit'>
			                        ...
			                        <div class='form_box'>
			                            <input type="text" id="or_hp" name="phoneNumber" value="${row.phoneNumber}">
			                        </div>
			                    </li>
			                    <li>
			                        <div class='l_tit'>
                        ...
                        <input type="hidden" id="home_zip" value=""> <input type="hidden" id="home_addr1" value=""> <input type="hidden" id="home_addr2" value="">
                        <div class="f_top">
                            <h2>수령/배송정보</h2>
                            <div class="checkbox type2">
                                <input type="checkbox" name="copy_mem_info" id="copy_mem_info" value="Y" onclick="order.setReAddr();"> <label for="copy_mem_info">주문자와 동일</label>
                            </div>
                        </div>
                        <ul>
                            <!-- 수령방법 - 직접픽업 선택시 -->
                            <li class="receive_way_con pickup">
                                <ul>
                                    ...
                                    <li class="receipt_memo_con">
                                        ...
                                        <div class="form_box">
                                            <textarea name="orderRequest" id="receipt_memo" placeholder="내용을 입력해주세요." style="width:100%;height:86px;padding:10px;font-size:14px;"></textarea>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <div class="form_area right">
                        ...
                        <ul>
                            <li class="t_price" style="margin: -23px 0px 21px;">
                                ...
                                <div class="form_box">
                                    <p id="order_price_span"><fmt:formatNumber value="${totalPrice}" pattern="#,###" />원</p>
                                </div>
                            </li>
                           <!--  <li class="coupon">
                                <div class="l_tit">
                            ...
                            <li class="mileage">
                                ...
                                <div class="form_box">
                                    <div class="ip_box">
                                        <input type="text" id="use_reserve" name="points" value="0" class="numeric" title="사용할 포인트">
                                    </div>
                                    <div id="result2">
                        ...
                        <div class="t_price_info">
                            <dl>
                                <dt>총 구매금액</dt>
                                <dd id="totalPurchasePrice"><fmt:formatNumber value="${totalPrice}" pattern="#,###" />원</dd>
                            </dl>
                    ...
                    <!--         <dl>
                            ...
                            <dl class="total">
                                <dt>최종결제금액</dt>
                                <dd id="finish_price_span"><fmt:formatNumber value="${finalPrice}" pattern="#,###" />원</dd>
                            </dl>
                            <dl class="pay">
                                <dt>결제수단</dt>
                                <dd>
