				...
				<ul class="depth_01">
					...
					<li><a href="#none">개인정보</a>
						<ul class="depth_02">
							...
							<li class="on"><a href="/change_password.do">비밀번호
									변경</a></li>
...
<div class="content mypage accont change_password_page">
        <div class="inner">
            ...
            <div class="form_area">
                <form action="https://www.winenara.com/shop/mypage/account/change_password_proc" name="modify_form" id="modify_form" method="post" accept-charset="utf-8">
<input type="hidden" name="witplus_csrf_token" value="b9f6e965f7f51f2e9c911cf0c52fe37b">                                                                       
                    <ul>
                        <li>
                            <div class="l_tit">
                            ...
                            <div class="form_box">
                                <input type="password" id="default_pw" placeholder="기존 비밀번호 확인" name="passwd">
                        ...
                        <li>
                            ...
                            <div class="form_box">
                                <input type="password" id="new_pw_01" placeholder="신규 비밀번호를 입력하세요" name="new_passwd">
                                <p class="input_info_txt"></p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="form_box">
                                <input type="password" id="new_pw_02" placeholder="신규 비밀번호를 한번 더 입력하세요" name="new_passwd_chk">
                                <p class="input_info_txt"></p>
                            </div>
                        </li>                                        
                    </ul>
            ...
            <div class="btn_area">
                <button type="button" class="btn_txt btn_black" onclick="pass_submit()">비밀번호 변경</button>
            </div>            
        </div>
    </div>
</body>
