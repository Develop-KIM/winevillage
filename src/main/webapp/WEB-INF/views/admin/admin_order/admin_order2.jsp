...
<div id="snb">
	...
	<div id="content">
		<div class="breadcrumb">
			<span>HOME</span> <i class="ionicons ion-ios-arrow-right"></i> 주문관리 <i class="ionicons ion-ios-arrow-right"></i> 입금대기		</div>
...
<div class="local_ov mart30">
	...
	<select id="page_rows" onchange="location='/admin/order.php?code=1&page=1&page_rows='+this.value;" class="marl5">
...
<input type="hidden" name="q1" value="code=1">
...
<a href="./order/order_excel.php?code=1" class="btn_lsmall white"><i class="fa fa-file-excel-o"></i> 검색결과 엑셀저장</a></div>
...
<div class="information">
	...
	<div class="content">
		...
		<div class="desc01 accent">
			...
			<p class="fc_red">ㆍ<strong>주의!</strong> 삭제 및 취소된 주문 정보는 복구가 불가능하므로 신중하게 해야합니다.</p>
		</div>
	 </div>
</div>
