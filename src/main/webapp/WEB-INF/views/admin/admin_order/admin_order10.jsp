...
<div id="snb">
	...
	<div id="content">
		<div class="breadcrumb">
			<span>HOME</span> <i class="ionicons ion-ios-arrow-right"></i> 주문관리 <i class="ionicons ion-ios-arrow-right"></i> 배송후 교환		</div>
...
<div class="local_ov mart30">
	...
	<select id="page_rows" onchange="location='/admin/order.php?code=8&page=1&page_rows='+this.value;" class="marl5">
...
<input type="hidden" name="q1" value="code=8">
...
<a href="./order/order_excel.php?code=8" class="btn_lsmall white"><i class="fa fa-file-excel-o"></i> 검색결과 엑셀저장</a></div>
...
<div class="information">
	...
	<div class="content">
		...
		<div class="desc01 accent">
			<p>ㆍ교환 리스트 내 주문은 상태변경 및 원복이 불가능하며, 삭제도 하실 수 없습니다.</p>
		</div>
	 </div>
</div>
