...
<div id="snb">
	...
	<div id="content">
		<div class="breadcrumb">
			<span>HOME</span> <i class="ionicons ion-ios-arrow-right"></i> 주문관리 <i class="ionicons ion-ios-arrow-right"></i> 배송중		</div>
...
<div class="local_ov mart30">
	...
	<select id="page_rows" onchange="location='/admin/order.php?code=4&page=1&page_rows='+this.value;" class="marl5">
...
<input type="hidden" name="q1" value="code=4">
...
<a href="./order/order_excel.php?code=4" class="btn_lsmall white"><i class="fa fa-file-excel-o"></i> 검색결과 엑셀저장</a></div>
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col" colspan="2">배송회사</th>
	...
	<tbody>
	<tr><td colspan="15" class="empty_table">자료가 없습니다.</td></tr>	</tbody>
	</table>
</div>
