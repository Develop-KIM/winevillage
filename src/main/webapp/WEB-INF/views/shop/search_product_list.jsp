								...
								<div class="btn">
									<c:choose>
										<c:when test="${user_id != null && user_id != ''}">
											<div data-product-cd="${row.productCode }">
												<button type="button" class="wish wish_${row.productCode } "
													id="wish_${row.productCode }" onclick="wishlist(this)">
													<span>찜하기</span>
												</button>
											</div>
										</c:when>
										<c:otherwise>
											<button type="button" class="wish wish_${row.productCode } "
												id="wish_${row.productCode }" onclick="$('.layer.login_layer').show();">
												<span>찜하기</span>
											</button>
										</c:otherwise>
									</c:choose>
