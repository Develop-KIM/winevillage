...
<html lang="ko">
<head>
<title>WINENARA 1987 ㅣ 회원정보수정    </title>
...
<header id="header" class="header mypage_index_header">
	...
	<div class="mb_lnb pc_hidden">
		<ul>
			...
			<li class="btn_wish"><button type="button" onclick="location.href='/shop/mypage/note/wish_lists'"><span>WISH LIST</span></button>
			</li>
			<li class="btn_mypage"><button type="button" onclick="location.href='/shop/mypage/shopping/mypage'"><span>MY PAGE</span></button>
			</li>
		</ul>
	</div>
