		...
		<div class="content main_page">
			<div class="main_visual">
				<div class="m_slide">
					<a href="event/event_viewd86e.html?no=361">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=1"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=1"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=1" alt=""><!-- pc이미지 -->
							</picture>
					...
					</a> <a href="event/event_viewcd96.html?no=359">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=2"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=2"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=2" alt=""><!-- pc이미지 -->
							</picture>
							<p class="visual_category"></p>
							<div class="visual_txt">
								<p class="tit"></p>
					...
					</a> <a href="event/event_viewb920.html?no=357">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=3"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=3"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=3" alt=""><!-- pc이미지 -->
							</picture>
							<p class="visual_category"></p>
							<div class="visual_txt">
								<p class="tit"></p>
					...
					</a> <a href="event/event_view842d.html?no=356">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=4"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=4"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=4" alt=""><!-- pc이미지 -->
							</picture>
							<p class="visual_category"></p>
							<div class="visual_txt">
								<p class="tit"></p>
					...
					</a> <a href="event/event_viewa08c.html?no=352">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=5"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=5"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=5" alt=""><!-- pc이미지 -->
							</picture>
							<p class="visual_category"></p>
							<div class="visual_txt">
								<p class="tit"></p>
					...
					</a> <a href="event/event_view668c.html?no=344">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=6"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=6"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=6" alt=""><!-- pc이미지 -->
							</picture>
							<p class="visual_category"></p>
							<div class="visual_txt">
								<p class="tit"></p>
					...
					</a> <a href="event/event_view5c18.html?no=354">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=7"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=7"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=7" alt=""><!-- pc이미지 -->
							</picture>
							<p class="visual_category"></p>
							<div class="visual_txt">
								<p class="tit"></p>
					...
					</a> <a href="event/event_view931a.html?no=297">
						<div class="slide">
							<picture>
							<source srcset="https://picsum.photos/1200/400?random=8"
								media="(min-width:1024px)">
							<!-- pc이미지 -->
							<source srcset="https://picsum.photos/1200/400?random=8"
								media="(max-width:1023px)">
							<!-- mb이미지 --> <img
								data-lazy="https://picsum.photos/1200/400?random=8" alt=""><!-- pc이미지 -->
							</picture>
							<p class="visual_category"></p>
							<div class="visual_txt">
								<p class="tit"></p>
			...
			<div class="main_category pc_hidden">
				<ul>
					...
					<li class="ico_beerLiquor"><a
						href="product/product_listsfcd2.html?sh_category1_cd=20000">BEER&LIQUOR</a></li>
					<li class="ico_shop"><a href="company/store.html">SHOP</a></li>
					<li class="ico_event"><a href="event/event_lists.html">PROMOTION</a></li>
				</ul>
			</div>
			...
			<script>
				...
				$(document).ready(
						function() {
							$('.main_layer').each(
									function(idx, item) {
										var targetId = $(item).find(
												".not_today input").attr('id');
				...
				function exit(tg) {
					var targetLayer = $(tg).parents(".main_layer"), target = targetLayer
							.find(".not_today input"), targetId = target
							.attr("id");
					...
					$.ajax({
						...
						success : function(res) {
							if (res != "") {
								...
								commonUI.layer.open('review_img_layer.html');
				...
				$(".result_tab li button")
						.on(
								...
								function() {
									...
									var $post = $outer.find(
											' > .prd_wrap > .theme_prd_list')
											.eq(index);
									$current.removeClass('on');
									$post.addClass('on');

									$('.theme_con .theme_prd_list').each(
											function() {
												if ($(this).hasClass("on")) {
													$(this).css("display",
															"block");
				...
				product.likeProduct = function(product_cd) {
					...
					if (now_url.indexOf("/main") > -1) {
						...
						var url = "../note/wish_proc_ajax?ajax_mode="
								+ ajax_mode;
					} else {
					...
					if ($("#session_id").val()) {
						...
						commonUI.layer.open('login_layer.html');
					}
				}
				...
				function loadScrollsetCookie(name, value, expires, path,
						domain, secure) {
					var curCookie = name
							+ "="
							+ escape(value)
