...
function filter_submit() {
  ...
  $("#page").val(1);
  $("input[name='searchField_wine']:checked, input[name='priceRange']:checked, input[name='searchField_country']:checked, input[name='searchField_grapeVariety']:checked").each(function() {
    if (seq == "") {
        seq = String($(this).val());
    } else {
...
function DelFilterEvent() {
  ...
  $(".current_filter").on('click', "button[name='del_btn']", function() {
    ...
    $("input:checkbox[name='searchField_wine']:checked").each(function() {
...
function all_reset() {
  $("#sh_filter_code").val("");
  $("input:checkbox[name='searchField_wine']").prop("checked", false);
  $("input:checkbox[name='searchField_country']").prop("checked", false);
  $("input:checkbox[name='searchField_grapeVariety']").prop("checked", false);
